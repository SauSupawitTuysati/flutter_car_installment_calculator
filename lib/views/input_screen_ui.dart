            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    setState(() {
                      _carPriceCtrl.clear(); // ล้างช่องราคารถ
                      _interestCtrl.clear(); // ล้างช่องดอกเบี้ย
                      _downCtrl = 10; // รีเซ็ต radio
                      _monthCtrl = 24; // รีเซ็ต dropdown
                      _imageFile = null; // ล้างรูปภาพ
                    });
                  },
                  child: Text(
                    'ยกเลิก',
